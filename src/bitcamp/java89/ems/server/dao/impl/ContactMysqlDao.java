...
public class ContactMysqlDao implements ContactDao {
  ...
  public void insert(Contact contact) throws Exception {
    ...
    try (
      PreparedStatement stmt = con.prepareStatement("insert into ex_contacts(name,email,tel,posi) values(?,?,?,?)");) {
  ...
  public void update (Contact contact) throws Exception {
    ...
    try (
      PreparedStatement stmt = con.prepareStatement("update ex_contacts set name=?, tel=?, posi=? where email=?");) {
